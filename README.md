<p align="center">
<img src="https://github.com/user-attachments/assets/964b20e4-fcdd-4370-867c-9c0ef14c5230" />
</p>
...
```bash
  ...
  Or Simply run the build script from root of the source folder (-h for more options)

  ./build-superior.sh <devicecodename>
```
